export const technologies = [
  {
    ...
    icon: 'https://cdn.jsdelivr.net/npm/bootstrap-icons@1.13.1/icons/file-person.svg',
  },
  {
    name: 'Esai / Resume',
    description: 'Penulisan esai motivasi atau ringkasan materi PKKMB',
    icon: 'https://cdn.jsdelivr.net/npm/bootstrap-icons@1.13.1/icons/book.svg',
  },
  {
    name: 'Jurnal / Laporan Kegiatan',
    description: 'Penulisan jurnal refleksi atau laporan kegiatan harian',
    icon: 'https://cdn.jsdelivr.net/npm/bootstrap-icons@1.13.1/icons/journals.svg',
  },
  {
    name: 'Terjemahan Tugas',
    description: 'Menerjemahkan tugas kuliah dari/ke Bahasa Inggris secara akurat',
    icon: 'https://cdn.jsdelivr.net/npm/bootstrap-icons@1.13.1/icons/translate.svg',
  },
  {
    name: 'Konversi File (PDF / Word / Foto)',
    description: 'Mengubah tugas ke format pengumpulan yang diinginkan',
    icon: 'https://cdn.jsdelivr.net/npm/bootstrap-icons@1.13.1/icons/file-earmark-pdf.svg',
  },
  {
    name: 'Koreksi EYD & Tata Bahasa',
    description: 'Pemeriksaan ejaan, tanda baca, dan tata bahasa akademik',
    icon: 'https://cdn.jsdelivr.net/npm/bootstrap-icons@1.13.1/icons/spellcheck.svg',
  },
  {
    name: 'Penulisan Formal',
    description: 'Menyusun kalimat akademik dan bahasa formal sesuai standar',
    icon: 'https://cdn.jsdelivr.net/npm/bootstrap-icons@1.13.1/icons/file-richtext.svg',
  },
];
