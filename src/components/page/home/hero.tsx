      ...
      >
        ...
        <div className='relative z-10 mx-auto max-w-7xl w-full pt-20 md:pt-0 text-center'>
          <TextAnimate
            ...
            duration={0.3}
          >
            Kami Bantu Selesaikan Tugas Sekolah/Kuliah
            Kamu, <br />
            Mulai dari{' '}
          ...
          <TextAnimate
            ...
            duration={0.3}
          >
            Joki Go Fast siap bantu kamu selesaikan tugas-tugas kuliah dan sekolah dengan cepat, rapi, dan bebas drama.
Fokus nikmati sekolahmu dan kuliahmu — biar kami yang urus sisanya!
          </TextAnimate>
