...
<section id='tentang' className='py-16 md:py-32'>
  <div className='mx-auto max-w-screen-xl space-y-8 px-6 md:space-y-16'>
    ...
    >
      Layanan Joki Tugas Kuliah & Sekolah Akademik Terpercaya.
    </TextAnimate>
    <BlurFade className='relative'>
      <div className='relative z-10 space-y-4 md:w-1/2'>
        <p>
          JokiGoFast hadir sebagai solusi bagi mahasiswa baru yang kewalahan dengan tugas Kuliah & Sekolah seperti CV, esai motivasi, jurnal refleksi, dan laporan kegiatan.
        </p>
        <p>
          Tim kami terdiri dari editor profesional, penulis akademik, dan desainer dokumen berpengalaman yang telah menangani ratusan tugas dengan berbagai format dan standar kampus/sekolah.
        </p>
        <p>
          Kami menjunjung tiga nilai utama: hasil rapi & orisinal, harga yang masuk akal, dan pengerjaan cepat tanpa mengorbankan kualitas. Kamu fokus kuliah/sekolah, kami urus dokumenmu.
        </p>
        <div className='grid grid-cols-2 gap-3 pt-6 sm:gap-4'>
          <div className='space-y-3'>
            ...
            <p className='text-muted-foreground text-sm'>
              Tugas mahasiswa & siswa telah diselesaikan dengan sempurna
            </p>
          </div>
